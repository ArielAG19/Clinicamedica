...
namespace Clinicamedica.Controllers
{
    public class MedicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MedicoId,Nombre,Especialidad,Telefono,Correo")] Medico medico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MedicoId,Nombre,Especialidad,Telefono,Correo")] Medico medico)
        {
